...
const VOICE_CONFIG = {
    ...
    shimon: {
        ...
        voice: 'ballad',
        instructions: 'Speak in a rude, angry, and slightly aggressive tone. Sound very annoyed and impatient.' // ⬅️ שמעון כועס וגס
    },
    shirly: {
        model: 'gpt-4o-mini-tts',
        voice: 'coral',
        instructions: 'Speak in a pleasant, relaxed, flirty, and slightly stoner-like tone. Sound very calm and seductive.' // ⬅️ שירלי סטלנית וחרמנית
    },
