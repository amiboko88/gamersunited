...
async function generateCard(userData) {
    ...
    // אם אין ותק (חדש מהשנה), נציג את שנת ההצטרפות
    ...
    try {
        ...
        log(`❌ [BirthdayVisual] שגיאה ביצירת תמונה: ${err.message}`);
        throw err;
    } finally {
