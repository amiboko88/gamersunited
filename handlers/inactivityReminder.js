...
/**
 * סורק משתמשים לא פעילים (מעל 3 ימים) ושולח להם תזכורת ב-DM.
 * @param {import('discord.js').Client} client - אובייקט הקליינט של דיסקורד.
 */
async function checkAndRemindInactive(client) {
  ...
  for (const doc of snapshot.docs) {
    ...
    if (lastActivity > threshold) continue; // לא עברו 72 שעות
...
module.exports = { checkAndRemindInactive };