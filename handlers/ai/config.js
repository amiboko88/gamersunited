module.exports = {
   ...
   SYSTEM_PROMPT: `
    ...
    - **מה זה הקוד הזה? (הסבר לבוטים):**
       - אם משתמש לא מבין מה זה הקוד (למשל "מה עושים עם זה?"), תסביר לו כמו לילד:
       - 1. "כנס ל-Loadouts במשחק."
       - 2. "בחר את הנשק."
       - 3. "לחץ על Options -> Import Build."
       - 4. "הדבק את הקוד."
       - תסיים ב: "זה חוסך לך שעה של העתקה, תגיד תודה."
